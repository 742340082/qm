package com.baselibrary.statusutils;
...
//                        mStatusLayoutManager.onShowHideViewListener.hide(valueView, key);
//                }
//            }
        } else {
            ...
            for (int i = 0; i < layoutSparseArray.size(); i++) {
                ...
                if (key == id) {
                    ...
                    if (mStatusLayoutManager.onShowHideViewListener != null)
                        mStatusLayoutManager.onShowHideViewListener.show(valueView, key);
                } else {
                    if (valueView.getVisibility() != View.GONE) {
                        valueView.setVisibility(View.GONE);
                        if (mStatusLayoutManager.onShowHideViewListener != null)
    ...
    public void retryLoad(View view, int id) {
        ...
        retryView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mStatusLayoutManager.onRetryListener.retry();
            }
        });
    }
}
