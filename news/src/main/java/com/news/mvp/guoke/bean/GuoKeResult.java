package com.news.mvp.guoke.bean;
...
public class GuoKeResult extends DataSupport{
    ...
    @SerializedName("id")
    private long guokeresult_id;
    private GuoKe guoKe;

    public GuoKe getGuoKe() {
        return guoKe;
    }

    public void setGuoKe(GuoKe guoKe) {
        this.guoKe = guoKe;
    }

    public long getGuokeresult_id() {
        return guokeresult_id;
    }

    public void setGuokeresult_id(long guokeresult_id) {
        this.guokeresult_id = guokeresult_id;
    }

    private String category;
    private String style;
    private String title;
    private GuoKe.source_data source_data;
    ...
    public GuoKe.source_data getSource_data() {
        return source_data;
    }

    public void setSource_data(GuoKe.source_data source_data) {
