...
public class GameCategoryAdapter extends BaseQuickAdapter<CategoryData,BaseViewHolder> {
    public GameCategoryAdapter(int layoutResId) {
        super(layoutResId);
    }

    public GameCategoryAdapter(int layoutResId, List<CategoryData> data) {
