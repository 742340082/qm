package com.game.adapter.gamesearch;
...
public class GameSearchAdapter extends BaseQuickAdapter<Game,BaseViewHolder> {
    public GameSearchAdapter(int layoutResId, List<Game> data) {
        super(layoutResId, data);
    }

    public GameSearchAdapter(List<Game> data) {
        super(data);
    }

    public GameSearchAdapter(int layoutResId) {
        super(layoutResId);
    }
